...
const TOKEN_ADDRESS = 'JUPyiwrYJFskUPiHa7hkeR8VUtAeFoSYbKedZNsDvCN'; // Replace with Solana's token address
...
async function sendPriceUpdate() {
    ...
    if (price) {
        const message = `💚 *$JUP Price Update* 💚\n\n💰 1 $JUP = $${price.toFixed(2)} USD`;
